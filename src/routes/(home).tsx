  ...
  return (
    <>
      ...
      <div class="prose prose-indigo mx-auto dark:prose-invert sm:prose-sm lg:prose-lg xl:prose-xl">
        <p>
          Hey there! Thanks for stopping by my personal website. My name is Christoph and I'm a software developer, data
          scientist, and tech enthusiast. I'm always looking to learn new things and push myself to be the best I can
          be, and this website is a way for me to share my journey with you.
        </p>
        <p>
          On this site, you'll find out a little bit more about me and what I'm interested in. I'm really passionate
          about using technology to solve problems and make people's lives better, which is why I've chosen to work in
          the tech industry. I've got a solid foundation in computer science and I'm skilled in a bunch of different
