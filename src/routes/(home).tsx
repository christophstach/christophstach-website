    ...
    <>
      ...
      <div class="prose prose-indigo mx-auto dark:prose-invert sm:prose-sm lg:prose-lg xl:prose-xl">
        <p>
          ...
          with HTML frame sets and some very basic <a href="https://www.php.net/">PHP</a> scripts.
        </p>
        ...
        <p>
          ...
          next generation sequencing data. I always kept up to date with developing websites. My main interest is the
          ...
          <a href="https://svelte.dev/">Svelte</a> (especially SvelteKit) and{' '}
          <a href="https://tailwindcss.com/">Tailwind CSS</a>. Recently, <a href="https://nextjs.org/">Next.js</a>{' '}
