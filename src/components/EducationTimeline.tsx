        ...
        {(item) => {
          return (
            <Timeline.Item>
              ...
              <Timeline.Content>
                <p class="prose prose-sm prose-emerald mb-5 mt-4 max-w-none dark:prose-invert">{item.description}</p>

                <Show when={item.bullets.length > 0}>
                  <ul class="ml-4 list-disc text-sm">
                    <For each={item.bullets}>
                      {(bullet) => {
                        return <li class="prose prose-sm prose-emerald max-w-none dark:prose-invert">{bullet}</li>
                      }}
                    </For>
                  </ul>
                </Show>
